/////////////////////////////////////////////////////////////////////////////
//          File:: CQTFidIterator.cpp
// Create Author:: Raymond Yung
// Create   Date:: 30 Semptember 2000
//
//   Description:: The implementation file of the CQTFidIterator.h
//
//
/////////////////////////////////////////////////////////////////////////////
//
...
bool CQTFidIterator::ProcessFid()
{
...
void  CQTFidIterator::SetQuoteListPageFid(long lPage, short sFid)
{
	m_sFidNo = sFid;
	m_lPageNo = lPage;
...
// -------------------------------------------------------------------------
void CQTFidIterator::LogMsgToStatusList(CString strOutput, int iCodePage)
{
	CString strTemp;
...
// -------------------------------------------------------------------------
void CQTFidIterator::LogMessage(CString strOutput)
{
	if (m_bCheckFid)
...
// -------------------------------------------------------------------------
void CQTFidIterator::LogMessageWithBlankLine(CString strOutput, int iCodePage)
{
	if (m_bCheckFid)
	{
...
// -------------------------------------------------------------------------
// Process D1 - Char
bool CQTFidIterator::ProcessChar()
{
	char c = 0;
...
// -------------------------------------------------------------------------
// Print D1 - Char
void CQTFidIterator::PrintChar(char& c)
{
	CString strOutput;
...
// -------------------------------------------------------------------------
// Print D1 - Char
void CQTFidIterator::PrintChar(char& c, CString& strOutput)
{
	strOutput.Format("%d", c);
}

// -------------------------------------------------------------------------
// Process D2 - Unicode
bool CQTFidIterator::ProcessUnicode()
{
	WCHAR c;
	if (!m_pMsgObj->GetFid(m_sFidNo, c))
		return FALSE;
...
// -------------------------------------------------------------------------
// Print D2 - Unicode
void CQTFidIterator::PrintUnicode(WCHAR& c)
{
	CString strOutput;
...
// -------------------------------------------------------------------------
// Process D3 - short
bool CQTFidIterator::ProcessShort()
{
	short sh = 0;
...
// -------------------------------------------------------------------------
// Print D3 - short
void CQTFidIterator::PrintShort(short& sh)
{
	CString strOutput;
...
bool CQTFidIterator::ProcessUShort()
{
...
void CQTFidIterator::PrintUShort(unsigned short& ush )
{
	CString strOutput;
...
// -------------------------------------------------------------------------
// Process D5 - long
bool CQTFidIterator::ProcessLong()
{
	long l = 0;
...
// -------------------------------------------------------------------------
// Print D5 - long
void CQTFidIterator::PrintLong(long& l)
{
	CString strOutput;
...
bool CQTFidIterator::ProcessULong()
{
	unsigned long ul = 0;
...
void CQTFidIterator::PrintULong(unsigned long& ul)
{
	CString strOutput;
...
// -------------------------------------------------------------------------
// Print D6 - unsigned long
void CQTFidIterator::PrintULong(unsigned long& ul, CString& strOutput)
{
	strOutput.Format("%d(0x%x)", ul, ul);
}
// -------------------------------------------------------------------------
// Process D7 & D8 - float
bool CQTFidIterator::ProcessFloat()
{
	float f = 0;
...
// -------------------------------------------------------------------------
// Print D7 float
void CQTFidIterator::PrintFloat(float& f)
{
	CString strOutput;
...
// -------------------------------------------------------------------------
// Print D7 float
void CQTFidIterator::PrintFloat(float& f, CString& strOutput)
{
...
bool CQTFidIterator::ProcessUFloat()
{
	float f = 0;
	if (!m_pMsgObj->GetFid(m_sFidNo, f))
		return FALSE;
...
void CQTFidIterator::PrintUFloat(float& f)
{
	CString strOutput;
...
// -------------------------------------------------------------------------
// Process D9 - double
bool CQTFidIterator::ProcessDouble()
{
	double d = 0;
...
// -------------------------------------------------------------------------
// Print D9 - double
void CQTFidIterator::PrintDouble(double& d )
{
	CString strOutput;
...
bool CQTFidIterator::ProcessUDouble()
{
	double d = 0;
	if (!m_pMsgObj->GetFid(m_sFidNo, d))
		return FALSE;
...
void CQTFidIterator::PrintUDouble(double& d)
{
	CString strOutput;
...
// -------------------------------------------------------------------------
// Print D10 - unsigned double
void CQTFidIterator::PrintUDouble(double& d, CString& strOutput)
{
	strOutput.Format("%f", d);
}
// -------------------------------------------------------------------------
// Process D11 - CharArray
bool CQTFidIterator::ProcessCharArray()
{
	CharArray caOld;
...
// -------------------------------------------------------------------------
// Print D11 - CharArray
void CQTFidIterator::PrintCharArray(CharArray& caOld)
{
	CharArray ca;
...
// -------------------------------------------------------------------------
// Print D11 - CharArray
void CQTFidIterator::PrintCharArray(CharArray& caOld, CString& strOutput)
{
	CharArray ca;
	CNGUtil::ConvertUTF8ToBIG5(caOld, ca);
	strOutput.Format("%s", ca.GetString());
}

// -------------------------------------------------------------------------
// Print D11 - CharArray
void CQTFidIterator::PrintGBCharArray(CharArray& caOld, CString& strOutput)
{
	CharArray ca;
...
// -------------------------------------------------------------------------
// Print D11 - CharArray
void CQTFidIterator::PrintGBCharArray(CharArray& caOld)
{
	CharArray ca;
	CNGUtil::ConvertUTF8ToGB(caOld, ca);
	CString strOutput;
...
bool CQTFidIterator::ProcessMCharArray()
{
	MCharArray mcaOld;
...
void CQTFidIterator::PrintMCharArray(MCharArray& mcaOld)
{
	MCharArray mca2;
...
bool CQTFidIterator::ProcessBDateYear()
{
	BDateYear dy;
...
// -------------------------------------------------------------------------
// Print D13 - BDateYear
void CQTFidIterator::PrintBDateYear(BDateYear& dy)
{
	CString strOutput;
...
// -------------------------------------------------------------------------
// Print D13 - BDateYear
void CQTFidIterator::PrintBDateYear(BDateYear& dy, CString& strOutput)
{
	strOutput.Format("%d-%d-%d", dy.GetDay(), dy.GetMonth(), dy.GetYear());
}
// -------------------------------------------------------------------------
// Process D14 - BDateMonth
bool CQTFidIterator::ProcessBDateMonth()
{
	BDateMonth dm;
...
void CQTFidIterator::PrintBDateMonth(BDateMonth& dm)
{
	CString strOutput;
...
bool CQTFidIterator::ProcessBTimeMin()
{
	BTimeMin tm;
...
// -------------------------------------------------------------------------
// Print D15 - BTimeMin
void CQTFidIterator::PrintBTimeMin(BTimeMin& tm)
{
	CString strOutput;
...
bool CQTFidIterator::ProcessBTimeSec()
{
	BTimeSec ts;
...
// -------------------------------------------------------------------------
// Print D16 - BTimeSec
void CQTFidIterator::PrintBTimeSec(BTimeSec& ts)
{
	CString strOutput;
...
// -------------------------------------------------------------------------
// Print D16 - BTimeSec
void CQTFidIterator::PrintBTimeSec(BTimeSec& ts, CString& strOutput)
{
	strOutput.Format("%d:%d:%d", ts.GetHH(), ts.GetMIN(), ts.GetSS());
}

// -------------------------------------------------------------------------
// Process D17 - BTimeRanges
bool CQTFidIterator::ProcessBTimeRanges()
{
	BTimeRanges tr;
...
void CQTFidIterator::PrintBTimeRanges(BTimeRanges& tr)
{
	CString strOutput;
...
// -------------------------------------------------------------------------
// Process D18 - Tran
bool CQTFidIterator::ProcessTran()
{
	Tran tran;
...
// -------------------------------------------------------------------------
// Print D18 - Tran
void CQTFidIterator::PrintTran(Tran& tran)
{
	CString strOutput;
...
// -------------------------------------------------------------------------
// Process D19 - Txn
bool CQTFidIterator::ProcessTxn()
{
	Txn txn;
...
// -------------------------------------------------------------------------
// Print D19 - Txn
void CQTFidIterator::PrintTxn(Txn& txn)
{
	CString strOutput;
	BTimeMin tm;
	double vl = 0;
...
bool CQTFidIterator::ProcessShrOrdLst()
{
	ShrOrdLst sol;
...
// -------------------------------------------------------------------------
// Print D20 - ShrOrdLst
void CQTFidIterator::PrintShrOrdLst(ShrOrdLst& sol)
{
	CString strOutput;
...
// -------------------------------------------------------------------------
// Process D21 - PRCVOL 
bool CQTFidIterator::ProcessPrcVol()
{
	PrcVol prc;
...
// -------------------------------------------------------------------------
// Print D21 - PRCVOL 
void CQTFidIterator::PrintPrcVol(PrcVol& prc)
{
	CString strOutput;
...
// -------------------------------------------------------------------------
// Process D22 - BkrQue
bool CQTFidIterator::ProcessBkrQue()
{
	BkrQue bkrque;
...
// -------------------------------------------------------------------------
// Print D22 - BkrQue
void CQTFidIterator::PrintBkrQue(BkrQue& bkrque)
{
	CString strOutput;
...
// -------------------------------------------------------------------------
// Process D23 - Link
bool CQTFidIterator::ProcessLink()
{
	Link link;
...
// -------------------------------------------------------------------------
// Print D23 - Link
void CQTFidIterator::PrintLink(Link& link)
{
	CString strOutput;
...
// -------------------------------------------------------------------------
// Process D24 - Wlink
bool CQTFidIterator::ProcessWlink()
{
	WLink wlink;
...
// -------------------------------------------------------------------------
// Print D24 - Wlink
void CQTFidIterator::PrintWlink(WLink& wlink)
{
	CString strOutput;
	unsigned long ulLink;
...
// -------------------------------------------------------------------------
// Process D25 - YLabel
bool CQTFidIterator::ProcessYLabel()
{
	YLabel ylabel;
...
// -------------------------------------------------------------------------
// Print D25 - YLabel
void CQTFidIterator::PrintYLabel(YLabel& ylabel)
{
	CString strOutput;
...
bool CQTFidIterator::ProcessXMtcLabel()
{
	XMtcLabel xmtcLbl;
...
// -------------------------------------------------------------------------
// Print D26 - XMtcLabel
void CQTFidIterator::PrintXMtcLabel(XMtcLabel& xmtcLbl)
{
	CString strOutput;
...
bool CQTFidIterator::ProcessXDtcLabel()
{
	XDtcLabel xdtcLbl;
...
// -------------------------------------------------------------------------
// Print D27 - XDtcLabel
void CQTFidIterator::PrintXDtcLabel(XDtcLabel& xdtcLbl)
{
	CString strOutput;
	unsigned short nPos = 0;
	BDateMonth dt;
...
bool CQTFidIterator::ProcessMtcPoints()
{
	MtcPoints mtcPts;
...
// -------------------------------------------------------------------------
// Print D28 - MtcPoints
void CQTFidIterator::PrintMtcPoints(MtcPoints& mtcPts)
{
	CString strOutput;
	byte byPts = 0;
...
// -------------------------------------------------------------------------
// Process D29 - MtcVal
bool CQTFidIterator::ProcessMtcVal()
{
	MtcVal mtcval;
...
// -------------------------------------------------------------------------
// Print D29 - MtcVal
void CQTFidIterator::PrintMtcVal(MtcVal& mtcval)
{
	CString strOutput;
	float fVal = 0;
...
bool CQTFidIterator::ProcessDtcPoints()
{
	DtcPoints dtcPts;
...
// -------------------------------------------------------------------------
// Print D30 - DtcPoints
void CQTFidIterator::PrintDtcPoints(DtcPoints& dtcPts)
{
	CString strOutput;
	byte byHt = 0;
	byte byLw = 0;
...
// -------------------------------------------------------------------------
// Process D31 - HisVal
bool CQTFidIterator::ProcessHisVal()
{
	HisVal hisval;
...
// -------------------------------------------------------------------------
// Print D31 - HisVal
void CQTFidIterator::PrintHisVal(HisVal& hisval)
{
...
bool CQTFidIterator::ProcessFieldList()
{
	FieldList fldLst;
...
// -------------------------------------------------------------------------
// Print D32 - FieldList
void CQTFidIterator::PrintFieldList(FieldList& fldLst)
{
	CString strOutput;
...
bool CQTFidIterator::ProcessFieldLabel()
{
...
void CQTFidIterator::PrintFieldLabel(FieldLabel& fldLblOld)
{
	FieldLabel fldLbl;
...
// -------------------------------------------------------------------------
// Process D34 - InfoMsg
bool CQTFidIterator::ProcessInfoMsg()
{
...
// -------------------------------------------------------------------------
// Print D34 - InfoMsg
void CQTFidIterator::PrintInfoMsg(InfoMsg& infomsgOld)
{
	InfoMsg infomsg;
...
bool CQTFidIterator::ProcessHeadLine()
{
	HeadLine headline;
...
// -------------------------------------------------------------------------
// Print D35 - HeadLine
void CQTFidIterator::PrintHeadLine(HeadLine& headline)
{
	unsigned long nLn = 0;
	BDateMonth dt;
	BTimeSec tm;
...
// -------------------------------------------------------------------------
// Process D36 - HLink
bool CQTFidIterator::ProcessHLink()
{
	HLink hlink;
...
// -------------------------------------------------------------------------
// Print D36 - HLink
void CQTFidIterator::PrintHLink(HLink& hlink)
{
	CString strOutput;
	unsigned long ulPg = 0;
...
bool CQTFidIterator::ProcessMShrOrdLst()
{
	MShrOrdLst mshr;
...
void CQTFidIterator::PrintMShrOrdLst(MShrOrdLst& mshr)
{
	CString strOutput;
	ShrOrdLst shr;
...
// -------------------------------------------------------------------------
// Process D38 - SprTbl
bool CQTFidIterator::ProcessSprTbl()
{
...
// -------------------------------------------------------------------------
// Print D38 - SprTbl
void CQTFidIterator::PrintSprTbl(SprTbl& sprtbl)
{
	CString strOutput;
...
bool CQTFidIterator::ProcessQuoteList()
{
	QuoteList quoteList;
...
void CQTFidIterator::PrintQuoteList(QuoteList& quoteList)
{
	CString strOutput;
	byte yLn, yLen;
	short sFid;
	...
	int col[1024]={ULong,UFloat,UFloat,UFloat,UFloat,UFloat,Other,Other,Other,Other,Other,Other,Other,Other,Other,Other,Other,Other,Other,Other};
...
*/			}
	...
	if (m_bShowQuoteList)
	{
		if ((!m_bCheckFid) || (quoteList.GetTL() == 0))
			InitQuoteListCol(quoteList.GetTL(), iTotalCol);
		for (int iRow=0; iRow<quoteList.GetTL(); iRow++)
		{
			for (int iCol=0; iCol<iTotalCol; iCol++)
			{
				if (quoteList.GetQuote(iRow, iCol, yLen, pFV))
				{
					...
					LogMessage(strOutput);
					PrintQuote(col[iCol], yLen, pFV, iRow, iCol);
				}
			}
		}
	}
	...
	strOutput.Format("Page: %d (0x%x), Fid: %d(QuoteList), Total: %d, NE: %d", 
					 m_lPageNo, m_lPageNo, m_sFidNo, quoteList.GetTL(), quoteList.GetNE());
	LogMessageWithBlankLine(strOutput);

}
// -------------------------------------------------------------------------
void CQTFidIterator::InitQuoteListCol(int iRow, int iCol)
{
	m_QuoteListToolsDlg->InitQuoteListCol(iRow, iCol);
}


// -------------------------------------------------------------------------
void CQTFidIterator::PrintQuote(int iFidType, unsigned char& yLen, void*& pFV, int iRow, int iCol)
{
	CString strOutput = "";
	int iCodePage = 950;
	...
	case DateYear:
		{
			...
			PrintBDateYear(dy, strOutput)	;
		}
		break;
	case ULong:
		{
			PrintULong(*(unsigned long*)pFV, strOutput)	;
		}
		break;
	case UFloat:
		{
			PrintFloat(*(float*)pFV, strOutput)	;
		}
		break;
	case CCharArray:
	case ECharrArray:
		{
			...
			PrintCharArray(CA, strOutput)	;
		}
		break;
	case GBCharArray:
		{
			CharArray CA((unsigned char*)pFV);
			PrintGBCharArray(CA, strOutput)	;
			iCodePage = 936;
		}
		break;
	case UChar:
		{
			PrintChar(*(char*)pFV, strOutput);
		}
		break;                
	case UDouble:
		{
			PrintUDouble(*(double*)pFV, strOutput);
		}
		break;
	case BTimeSecEnum:
		{
			BTimeSec ts((unsigned char*)pFV);
			PrintBTimeSec(ts, strOutput);
		}
		break;
	}
	m_QuoteListToolsDlg->InsertQuoteCell(iRow, iCol, strOutput, iCodePage);
}
...
// -------------------------------------------------------------------------
void CQTFidIterator::PrintQuote(short& sFid, unsigned char& yLen, void*& pFV)
{
	fidDatabase fDB;
...
bool CQTFidIterator::ProcessMTCTicks()
{
	MTCTicks mtcTicks;
...
void CQTFidIterator::PrintMTCTicks(MTCTicks& mtcTicks)
{
	CString strOutput;
...
bool CQTFidIterator::ProcessMTCV()
{
	MTCV mtcv;
...
// -------------------------------------------------------------------------
// Print Type D41 - MTCV
void CQTFidIterator::PrintMTCV(MTCV& mtcv)
{
	CString strOutput;
...
bool CQTFidIterator::ProcessYHeadLine()
{
	YHeadLine yheadline;
...
void CQTFidIterator::PrintYHeadLine(YHeadLine& yheadline)
{
	unsigned long nLn = 0;
	BDateYear yr;
	BTimeSec tm;
...
// -------------------------------------------------------------------------
// Process D43 - OBkrQue
bool CQTFidIterator::ProcessOBkrQue()
{
	OBkrQue obkrque;
...
// -------------------------------------------------------------------------
// Print D43 - OBkrQue
void CQTFidIterator::PrintOBkrQue(OBkrQue& obkrque)
{
	CString strOutput;
	byte byA = 0;
	unsigned short unB = 0;
...
bool CQTFidIterator::ProcessKMultiple()
{
	long l = 0;
	if (!m_pMsgObj->GetFid(m_sFidNo, l))
		return FALSE;
...
void CQTFidIterator::PrintKMultiple(long& l)
{
	CString strOutput;
...
bool CQTFidIterator::Process10KMultiple()
{
	long l = 0;
	if (!m_pMsgObj->GetFid(m_sFidNo, l))
		return FALSE;
...
void CQTFidIterator::Print10KMultiple(long& l)
{
...
bool CQTFidIterator::ProcessBQueVOSN()
{
	BQueVOSN bquevosn;
...
// -------------------------------------------------------------------------
// Process D46 - BQueVOSN
void CQTFidIterator::PrintBQueVOSN(BQueVOSN& bquevosn)
{
	CString strOutput;
	byte byA = 0;
	unsigned short unB = 0;
...
// -------------------------------------------------------------------------
// Process D47 - MTCPTS
bool CQTFidIterator::ProcessMTCPTS()
{
	MTCPTS mtcPts;
	if (!m_pMsgObj->GetFid(m_sFidNo, mtcPts))
		return FALSE;
...
// -------------------------------------------------------------------------
// Print D47 - MTCPTS
void CQTFidIterator::PrintMTCPTS(MTCPTS& mtcPts)
{
	CString strOutput;
	byte byPts = 0;
	for (int i=0; i<mtcPts.GetNe(); i++)
...
// -------------------------------------------------------------------------
// Process D48 - MTCF
bool CQTFidIterator::ProcessMTCF()
{
	MTCF mtcf;
...
// -------------------------------------------------------------------------
// Print D48 - MTCF
void CQTFidIterator::PrintMTCF(MTCF& mtcf)
{
	CString strOutput;
...
bool CQTFidIterator::ProcessPrcVolwSeq()
{
	PrcVolwSeq prc;
	if (!m_pMsgObj->GetFid(m_sFidNo, prc))
		return FALSE;
...
void CQTFidIterator::PrintPrcVolwSeq(PrcVolwSeq& prc)
{
	CString strOutput;
