...
extern const MIDL_SERVER_INFO ApplManServer_ServerInfo;

extern const RPC_DISPATCH_TABLE ApplManServer_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE ApplManServer___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x039e14f0,0x7960,0x11d2,{0xbd,0xc9,0x00,0xc0,0x4f,0x88,0x1f,0x8d}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&ApplManServer_v1_0_DispatchTable,
    0,
    0,
    0,
    &ApplManServer_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE ApplManServer_v1_0_s_ifspec = (RPC_IF_HANDLE)& ApplManServer___RpcServerInterface;
...
static const MIDL_STUB_DESC ApplManServer_StubDesc = 
    {
    (void *)& ApplManServer___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION ApplManServer_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE ApplManServer_v1_0_DispatchTable = 
    {
    4,
    (RPC_DISPATCH_FUNCTION*)ApplManServer_table
    };

static const SERVER_ROUTINE ApplManServer_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)Log,
    (SERVER_ROUTINE)Trace,
    (SERVER_ROUTINE)Alert,
    (SERVER_ROUTINE)SetDataCtrlStatus
    };

static const MIDL_SERVER_INFO ApplManServer_ServerInfo = 
    {
    &ApplManServer_StubDesc,
    ApplManServer_ServerRoutineTable,
    RpcApplMan__MIDL_ProcFormatString.Format,
    ApplManServer_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
